...
function Screenshot({ src, alt, label, desc }: { src: string; alt: string; label: string; desc: string }) {
  ...
  return (
    <>
      <div className="rounded-xl overflow-hidden border border-white/10 bg-white/5 hover:bg-white/10 transition-all group cursor-pointer" onClick={() => setOpen(true)}>
        ...
        <div className="p-3">
          <p className="font-semibold text-sm text-indigo-300">{label}</p>
    ...
    <section className="max-w-6xl mx-auto px-4 py-12">
      ...
      <div className="p-8 md:p-12 mb-10 flex flex-col items-center">
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-6">
          <span className="px-3 py-1 rounded-full text-sm font-semibold bg-violet-500/20 text-violet-300 border border-violet-500/30">Symfony 7</span>
          <span className="px-3 py-1 rounded-full text-sm font-semibold bg-indigo-500/20 text-indigo-300 border border-indigo-500/30">PHP</span>
          <span className="px-3 py-1 rounded-full text-sm font-semibold bg-sky-500/20 text-sky-300 border border-sky-500/30">PostgreSQL</span>
          <span className="px-3 py-1 rounded-full text-sm font-semibold bg-amber-500/20 text-amber-300 border border-amber-500/30">Twig</span>
          <span className="px-3 py-1 rounded-full text-sm font-semibold bg-emerald-500/20 text-emerald-300 border border-emerald-500/30">Doctrine ORM</span>
          <span className="px-3 py-1 rounded-full text-sm font-semibold bg-blue-500/20 text-blue-300 border border-blue-500/30">Bootstrap</span>
          <span className="px-3 py-1 rounded-full text-sm font-semibold bg-yellow-500/20 text-yellow-300 border border-yellow-500/30">JavaScript</span>
        </div>
      ...
      <div className="space-y-10">
        ...
        {/* Contexte */}
        <div className="rounded-2xl border border-white/10 p-6 shadow-sm" style={{ background: 'linear-gradient(135deg, rgba(16,185,129,0.05), transparent)' }}>
          <h2 className="text-xl font-bold mb-3 flex items-center gap-2" style={{ color: '#34d399' }}>
            &#128218; Contexte
          </h2>
          <p className="leading-relaxed text-gray-300">
            La société <strong className="text-emerald-400">IMMOSYNC</strong> est un syndic de gestion de biens immobiliers.
            Elle doit organiser des travaux dans les appartements et parties communes qu'elle gère.
            Ce processus était jusqu'ici <strong className="text-emerald-400">manuel et source d'erreurs</strong>.
            Le projet a été réalisé en <strong className="text-emerald-400">équipe de 3</strong> lors de ma 2e année de BTS SIO SLAM,
            avec une partie web (Symfony) et desktop (Java).
            J'ai travaillé sur la <strong className="text-emerald-400">partie web Symfony</strong> : espaces inspecteur et entrepreneur.
          </p>
        </div>

        {/* Contenu + Objectifs */}
        <div className="grid md:grid-cols-2 gap-6">
          <div className="rounded-2xl border border-white/10 p-6 shadow-sm" style={{ background: 'linear-gradient(135deg, rgba(129,140,248,0.05), transparent)' }}>
          ...
          <div className="rounded-2xl border border-white/10 p-6 shadow-sm" style={{ background: 'linear-gradient(135deg, rgba(167,139,250,0.05), transparent)' }}>
        ...
        {/* Moyens utilisés */}
        <div className="rounded-2xl border border-white/10 p-6 shadow-sm" style={{ background: 'linear-gradient(135deg, rgba(96,165,250,0.05), transparent)' }}>
          <h2 className="text-xl font-bold mb-4 flex items-center gap-2 text-blue-300">
            &#128736;&#65039; Stack technique
          </h2>
          <div className="grid md:grid-cols-2 gap-5">
            <div>
              <h3 className="font-bold mb-2 text-sm uppercase tracking-wider text-blue-400">Technologies</h3>
              <div className="space-y-1.5">
                {[
                  ...
                  <div key={i} className="flex items-center gap-2 rounded-lg px-3 py-2 bg-white/5">
                    <span className="font-semibold text-sm text-blue-300">{name}</span>
                    <span className="text-xs text-gray-400">&mdash; {desc}</span>
                  </div>
                ))}
              </div>
            </div>
            <div>
              <h3 className="font-bold mb-2 text-sm uppercase tracking-wider text-indigo-400">Organisation</h3>
              <div className="space-y-1.5">
                {[
                  ...
                  <div key={i} className="flex items-center gap-2 rounded-lg px-3 py-2 bg-white/5">
                    <span className="font-semibold text-sm text-indigo-300">{name}</span>
                    <span className="text-xs text-gray-400">&mdash; {desc}</span>
                  </div>
                ))}
              </div>
        ...
        <div className="rounded-2xl border border-white/10 p-6 shadow-sm" style={{ background: 'linear-gradient(135deg, rgba(244,114,182,0.05), transparent)' }}>
          <h2 className="text-xl font-bold mb-2 flex items-center gap-2 text-pink-300">
            &#128248; Démonstration
          </h2>
          <p className="text-xs text-gray-400 mb-6">Cliquez sur une image pour l'agrandir</p>

          {/* Step 1 - Connexion */}
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-3">
              <StepNumber n={1} />
              <h3 className="font-bold text-base text-pink-300">Connexion</h3>
            </div>
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-3">
              <StepNumber n={2} />
              <h3 className="font-bold text-base text-pink-300">Espace Inspecteur</h3>
            </div>
          ...
          <div>
            <div className="flex items-center gap-3 mb-3">
              <StepNumber n={3} />
              <h3 className="font-bold text-base text-pink-300">Espace Entrepreneur</h3>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="rounded-2xl border border-white/10 p-6 shadow-sm" style={{ background: 'linear-gradient(135deg, rgba(251,191,36,0.05), transparent)' }}>
            <h2 className="text-xl font-bold mb-3 flex items-center gap-2 text-amber-300">
              &#9888;&#65039; Défis rencontrés
            </h2>
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="rounded-lg p-3 bg-amber-500/5 border border-amber-500/10">
                  <p className="font-semibold text-sm text-amber-300">{title}</p>
        ...
        <div className="rounded-2xl border border-white/10 p-6 shadow-sm" style={{ background: 'linear-gradient(135deg, rgba(167,139,250,0.05), transparent)' }}>
          ...
          <p className="leading-relaxed text-gray-300 text-sm">
            Ce projet m'a fait découvrir <strong className="text-purple-400">Symfony</strong> en conditions réelles.
            On a eu des difficultés d'organisation à 3 (répartition des tâches, merges Git compliqués)
            et des <strong className="text-purple-400">problèmes de BDD partagée</strong> entre Doctrine et Hibernate (conflits de schéma, colonnes qui ne correspondaient pas).
            Ça m'a appris à mieux <strong className="text-purple-400">définir les rôles dès le départ</strong> et à se mettre d'accord sur le schéma avant de coder.
          </p>
        </div>
