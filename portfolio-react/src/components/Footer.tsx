  ...
  return (
    <footer className="border-t border-gray-200 mt-14">
      ...
      <div className="container-page py-8 text-sm text-gray-600 flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
        <p>© 2025 Levana Wizman | Portfolio BTS SIO SLAM</p>
        <div className="flex gap-4">
          <a className="hover:text-indigo-600 transition-transform hover:translate-x-0.5" href="mailto:levanawizman25@gmail.com">Email</a>
